...
var XpiInstaller = {
	...
	extVersion: '1.2.200803',
	extAuthor: 'Karel Sommer',
	extLocaleNames: ['en-US', 'fr-FR', 'cs-CZ', 'de-DE', 'sv-SE', 'pl-PL', 'sk-SK', 'es-ES', 'pt-BR', 'hu-HU', 'nl-NL', 'fi-FI', 'it-IT', 'ko-KR', 'nb-NO', 'sl-SI', 'tr-TR', 'zh-CN', 'ru-RU', 'zh-TW', 'uk-UA'], // e.g. ['en-US', 'en-GB']
